...
export const projects: Project[] = [
  ...
  },
  {
    ...
    company: "Freelance",
    description:
      "Este proyecto fue desarrollado utilizando React, Typescript y Tailwind como parte de mi aprendizaje en dichas tecnologías. Fue una excelente oportunidad para poner en práctica mis conocimientos y habilidades en este framework, y me permitió profundizar en sus características y funcionalidades.",
  ...
  },
  {
    ...
    description:
      "Plataforma web educativa diseñada para servir a la comunidad de aprendizaje de empleados municipales, proporcionándoles acceso a recursos pedagógicos especializados y herramientas de comunicación colaborativa, con el objetivo de fomentar la educación y concienciación en materia de seguridad vial.",
